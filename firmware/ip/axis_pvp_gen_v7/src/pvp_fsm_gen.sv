...
module pvp_fsm_gen 
	...
	input [9:0] DAC_0_PVP_WIDTH_REG;
	input [9:0] DAC_1_PVP_WIDTH_REG;
	input [9:0] DAC_2_PVP_WIDTH_REG;
	input [9:0] DAC_3_PVP_WIDTH_REG;
	...
	// Abbie has eliminated modes for now
	assign ldacn = ldacn_fsm;
	assign resetn =  1'b1;
	assign clrn =  1'b1;
