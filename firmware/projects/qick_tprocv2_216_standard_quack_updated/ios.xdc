...
set_property PACKAGE_PIN AV9 [get_ports { select_mux_0[4] }]
set_property IOSTANDARD LVCMOS18 [get_ports { select_mux_0[4] }]
set_property PACKAGE_PIN AW9 [get_ports { select_mux_0[3] }]
set_property IOSTANDARD LVCMOS18 [get_ports { select_mux_0[3] }]
set_property PACKAGE_PIN AV10 [get_ports { select_mux_0[2] }]
set_property IOSTANDARD LVCMOS18 [get_ports { select_mux_0[2] }]
set_property PACKAGE_PIN AP10 [get_ports { select_mux_0[1] }]
set_property IOSTANDARD LVCMOS18 [get_ports { select_mux_0[1] }]
set_property PACKAGE_PIN AP11 [get_ports { select_mux_0[0] }]
set_property IOSTANDARD LVCMOS18 [get_ports { select_mux_0[0] }]
set_property PACKAGE_PIN AU10 [get_ports CS_0]
set_property IOSTANDARD LVCMOS18 [get_ports CS_0]
set_property PACKAGE_PIN AR12 [get_ports LDACN_0]
set_property IOSTANDARD LVCMOS18 [get_ports LDACN_0]
set_property PACKAGE_PIN AT12 [get_ports RESETN_0]
set_property IOSTANDARD LVCMOS18 [get_ports RESETN_0]
set_property PACKAGE_PIN AR10 [get_ports CLRN_0]
set_property IOSTANDARD LVCMOS18 [get_ports CLRN_0]
set_property PACKAGE_PIN AT10 [get_ports COPI_0]
set_property IOSTANDARD LVCMOS18 [get_ports COPI_0]
set_property PACKAGE_PIN AR11 [get_ports SCK_0]
